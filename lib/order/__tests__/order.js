...
test('atrule combination from most specified to least specified', () =>
	runTest(
		'atrule',
		{
			order: [
...
test('Should sort inside nested atrule', () =>
	runTest(
		'nested-atrule',
		{
			order: ['custom-properties', 'declarations', 'atrule'],
		},
		__dirname
	));
...
test('Should preserve indentation', () =>
	runTest(
		'indent',
		{
			order: ['declarations', 'rules', 'atrule'],
		},
		__dirname
	));
